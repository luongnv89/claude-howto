...
| `/agents` | Видалено: майстер прибрали у v2.1.198, а команда зникла з меню `/` і `/help` у v2.1.281 — попросіть Claude створити або налаштувати субагентів чи відредагуйте `.claude/agents/` | Керування субагентами через запит до Claude |
