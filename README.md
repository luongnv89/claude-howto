...
[![Version](https://img.shields.io/badge/version-2.1.283-brightgreen)](CHANGELOG.md)
...
- **Actively maintained** — synced with every Claude Code release (latest: v2.1.283, September 2026)
...
**Is this maintained?**
Actively. The guide is synced with every Claude Code release. Current version: v2.1.283 (September 2026), compatible with Claude Code 2.1+.
